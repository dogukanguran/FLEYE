...
Smtp::Smtp(const QString &serverName, const QString &username, const QString &password, const QString &from_, const QStringList &to, const QString &subject, const QString &body)
{
